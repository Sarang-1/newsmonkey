        ...
        return (
            <div>
                <div className="card" style={{minHeight: 400}}>
                    ...
                    <img src={imageUrl ? imageUrl : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIvAyt56wZnto4FKG5B_HnP_jsqjZeWgPBWA&usqp=CAU'} className="card-img-top" alt="..." />
